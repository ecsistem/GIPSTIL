      ...
      <div className="space-y-2 pt-6 pb-4 md:space-y-5">
        <div className="flex flex-col-reverse items-start sm:flex-row">
          <div className="flex flex-col pr-8">
            ...
            <h2 className="mb-1 text-xl font-bold tracking-tight text-zinc-600 dark:text-white md:text-2xl">
              Grupo Interdisciplinar de Pesquisa sobre Sociedade, Tecnologia, Inovação e Linguagens.
            </h2>
          </div>
        ...
        <p className="space-y-4 text-zinc-500 dark:text-slate-300">
          <p className="my-4 leading-loose">
            ...
            ! Somos uma equipe formada por pesquisadores comprometidos em explorar os impactos da
            tecnologia e inovação em nossa sociedade, bem como seus efeitos nas diferentes
            linguagens que utilizamos para nos comunicar. Como um grupo de pesquisa interdisciplinar
            dentro da UFPA, acreditamos que a colaboração entre diferentes áreas é fundamental para
            entendermos as complexidades do mundo contemporâneo. Contamos com especialistas em
            diversas áreas, como sociologia, antropologia, linguística, tecnologia da informação,
            dentre outras. Em nosso site, você encontrará informações sobre nossas pesquisas,
            projetos desenvolvidos, publicações, eventos e demais atividades relacionadas ao nosso
            grupo. Fique à vontade para navegar e conhecer mais sobre o nosso trabalho! Se tiver
            alguma dúvida ou quiser entrar em contato conosco, utilize os formulários disponíveis no
            site ou envie um e-mail diretamente para nós. Será um prazer conversar com você e trocar
            ideias sobre as pesquisas que desenvolvemos aqui na UFPA.{' '}
          </p>
        </p>
